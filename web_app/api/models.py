...
def generate_unique_post_id(length=10):
    while True:
...
class Post(models.Model):
    ...
    body = models.TextField(max_length = 500, null = False, default="NA")
    author = models.ForeignKey(User, on_delete = models.CASCADE)
    date_created = models.DateField(auto_now_add = True)
    likes = models.IntegerField(default = 0)
    image = models.ImageField(upload_to="frontend/static/images/posts", null=True)
